...
try {
    ...
    $users = [
        ...
        ['Arto_Ragil', 'Muhamad Arto Ragil Putra', 'arto14@gmail.com', 'arts.jpg', 'seorang seniman dan pencinta keindahan yang hidup bebas dan mandiri, tak dikendalikan oleh siapa pun.', 'Menggambar (manual atau digital), Melukis (cat minyak akrilik cat air dll.)'],
        ['Saddam_Davi', 'Saddam Davi', 'madas54@gmail.com', 'sddm.jpg', 'translator yang suka belajar bahasa asing.', 'bahasa arab, latin, mandarin'],
        ['Faiz', 'Faiz Arko Alhaqni', 'faizarkogaming@gmail.com', 'Faiz.jpg','Konten kreator gaming dengan keahlian dalam editing video, serta mahir menggunakan Microsoft Word dan Excel untuk kebutuhan dokumen dan analisis data.', 'Konten kreator gaming, microsoft word, Microsoft excel'],
